...
if [ "$MISSING_VALUE" = "yes" ]; then
	echo "Usage: setup # [pm|cb] [#], where the first # is the server number and the second value indicates the type of server, while the optional last number indicates the number of that type."
	exit 0
fi
